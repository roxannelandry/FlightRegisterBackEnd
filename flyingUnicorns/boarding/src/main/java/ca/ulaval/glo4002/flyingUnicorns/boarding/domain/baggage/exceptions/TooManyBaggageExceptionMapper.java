...
public class TooManyBaggageExceptionMapper implements ExceptionMapper<TooManyBaggageException> {

  @Override
  public Response toResponse(TooManyBaggageException exception) {
    return Response.status(Status.OK).entity(getRefusalReason(exception)).type("application/json").build();
  }

  private RefusedBaggageDto getRefusalReason(TooManyBaggageException exception) {
